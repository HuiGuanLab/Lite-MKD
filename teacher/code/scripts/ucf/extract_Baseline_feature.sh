...
modality_dict[rgb]="work/ucf/single/rgb/Baseline1/checkpoint70000.pt"
modality_dict[depth]="work/ucf/single/depth/Baseline/checkpoint70000.pt"
modality_dict[flow]="work/ucf/single/flow/Baseline/checkpoint70000.pt"

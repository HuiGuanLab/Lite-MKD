...
export checkpoint_dir="work/hmdb/fusion/trx/Combination_r+d+f_lr0.00001" # save dir
export model="ThreeTRXCombination"  # model name
export m2='depth'
export m3='flow'
export m4='skeleton'
export shirt_num=1
...
CUDA_VISIBLE_DEVICES=${DEVICES} python3 multi_fusion.py -c ${checkpoint_dir} --query_per_class 4 --shot 5 --way 5 \
    ...
    --temp_set 2 -lr 0.00001 --model ${model} --m2 ${m2} --m3 ${m3} --m4 ${m4} --shirt_num ${shirt_num} --trans_num 2

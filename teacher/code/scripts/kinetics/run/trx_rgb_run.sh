modality=rgb 
dateset=kinetics 
CUDA_VISIBLE_DEVICES=0,1 python3 run.py -r -c work/${dateset}/${modality}_trx_lr0.0001 --query_per_class 4 --shot 5 --way 5 \
...
--print_freq 50  --training_iterations 50010 --modality ${modality}
...
#     --method resnet50 --img_size 224 --scratch new --num_gpus 1 --print_freq 50 --save_freq 5000  \
#     --training_iterations 50010 --model ThreeTRXShiftLoopTime\
#     --temp_set 2 -lr 0.0001 --test_model_only True --test_model_path  work/ucf/fusion/trx/final/lr0.0001_tempset2/checkpoint5000.pt --trans_num 2

# # 使用kinetics数据集的参数来测试ucf101
# dataset="ucf"

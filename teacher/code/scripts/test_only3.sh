...
#     --method resnet50 --img_size 224 --scratch new --num_gpus 1 --print_freq 50 --save_freq 5000  \
#     --training_iterations 50010 --model ThreeTRXShiftLoopTime\
#     --temp_set 2 -lr 0.0001 --test_model_only True --test_model_path  work/hmdb/fusion/trx/ThreeTRXShiftLoopTime_trans2_r+d+f_lr0.00002/checkpoint5000.pt --trans_num 2

...
class TRX_2fcsup(nn.Module):
    ...
    def __init__(self, args, ):
        super(TRX_2fcsup, self).__init__()
        self.train()
        self.args = args       
    ...
    def forward(self,context_feature, context_labels, target_feature):
        ...
        all_logits_1=self.transformers(context_feature_1, context_labels, target_feature_1)['logits']
        all_logits_2=self.transformers(context_feature_2, context_labels, target_feature_2)['logits']
...
class TRX_2fcsup_fixed(nn.Module):
    '''
    TRX分类器
    输入S和Q的特征  25，8，2048  20，8，2048
    输出分数   20，5
    ...
    def __init__(self, args, ):
        super(TRX_2fcsup_fixed, self).__init__()
        self.train()
        self.args = args       
        self.transformers = TemporalCrossTransformer(args, 2)
        self.supportKD = SupportDK(args)
    ...
    def forward(self,context_feature, context_labels, target_feature):
        ...
        with torch.no_grad():
            ...
            all_logits_1=self.transformers(context_feature, context_labels, target_feature)['logits']

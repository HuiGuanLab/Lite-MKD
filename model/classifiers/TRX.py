...
class TRX_fixed(nn.Module):
    ...
    def forward(self,context_feature, context_labels, target_feature):
        with torch.no_grad():
            ...
            context_feature = context_feature.reshape(-1, self.args.seq_len, self.args.trans_linear_in_dim) # 25 x 8 x 2048
            target_feature = target_feature.reshape(-1, self.args.seq_len, self.args.trans_linear_in_dim) # 25 x 8 x 2048

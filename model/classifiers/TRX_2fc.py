...
class TRX_fixed(nn.Module):
    ...
    def forward(self,context_feature, context_labels, target_feature):
        with torch.no_grad():
            all_logits=self.transformers(context_feature, context_labels, target_feature)['logits']
            model_dict={
            'logits':all_logits
                    }
        return model_dict

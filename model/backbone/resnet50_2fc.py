...
class resnet50_2fc(nn.Module):
    ...
    def __init__(self, args, ):
        super(resnet50_2fc, self).__init__()
        # self.train()
        self.args = args
        ...
        # self.fc1_2 = nn.Linear(2048, 2048) #res18最后输出变为2048
        # self.fc2_2 = nn.Linear(2048, 2048) #res18最后输出变为2048

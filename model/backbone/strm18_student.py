...
class strm18_student(nn.Module):
    ...
    def __init__(self, args, ):
        super(strm18_student, self).__init__()
        # self.train()
        self.args = args
    ...
    def forward(self, context_feature,context_labels, target_feature):
        ...
        context_features = self.attn_pat(context_features) # 200 x 16 x 512 
        target_features = self.attn_pat(target_features) # 160 x 16 x 512
        ...
        context_features_fr1=self.fc1(context_features)
        target_features_fr1=self.fc1(target_features)
        
        context_features_fr2=self.fc2(context_features)
        target_features_fr2=self.fc2(target_features)
        # print(1)
        # print(context_features_pat.shape)
        # print(context_features_fr1.shape)
        # print(context_features_fr2.shape)
        
        context_dict={
            'distance':context_features_pat,
            'trx1':context_features_fr1,
            'trx2':context_features_fr2
        }
        
        target_dict={
            'distance':target_features_pat,
            'trx1':target_features_fr1,
            'trx2':target_features_fr2
        }
        
        return context_dict,target_dict
